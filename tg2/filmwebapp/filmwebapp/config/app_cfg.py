# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in filmwebapp.
...
import filmwebapp
from filmwebapp import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': filmwebapp.model,
    'DBSession': filmwebapp.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "dbf901fc-2e5e-49fe-8926-a0a714a5d466",
